...
//! TilesetWriter HLOD + Phase 8–11 correctness (P0-1..P0-4) + KTX2/basisu packaging.
//!
...
//! KTX2: read `KHR_texture_basisu` B3DM; PATH sibling CRT for Windows basisu; opaque
//! `image/ktx2` pass-through on unpack failure. No atlas/weld/remesh. No large-area claim.
...
pub use texture::{
    basisu_path_prefixes, find_basisu, path_with_basisu_dirs, process_textures, ProcessedTexture,
    TextureData, TextureMetrics,
};
