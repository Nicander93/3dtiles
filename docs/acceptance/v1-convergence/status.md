...
| R01 | 修复 converter 设置持久化 - 核心实现 | 未开始 | - | 依赖 R00 完成 |
| R02 | 修复 converter 设置持久化 - 测试验证 | 未开始 | - | 依赖 R01 完成 |
...
1. 等待 R00 PR review 和合并
2. 启动 R01：分析 converter 设置持久化问题
3. 为 R03+ 准备 cherry-pick/merge 策略
