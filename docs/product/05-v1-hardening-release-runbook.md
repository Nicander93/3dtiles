...
- 最新主仓库提交：`590154b`（结构化前端错误诊断）/ `8047027`（processor 重建边界校验）/ `b03bf48`（Tileset 输入校验）
- converter 候选提交：`bbe1426`
- 最新候选安装包：`apps/desktop/src-tauri/target/release/bundle/nsis/GeoForge 3D_0.1.0_x64-setup.exe`
- 最新候选安装包 SHA256：`a6b92ecdde25d2eddac08b9fb477f8658c7ad877a268d3caadcbe4386fc3d9ea`
